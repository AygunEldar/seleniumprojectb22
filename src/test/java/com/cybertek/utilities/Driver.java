...
public class Driver {
    ...
    /*
        ...
        so this class  object is not reachable from outside
         */
    private Driver (){}
...
/*
Creating re usable utility that will return same " driver" instance everytime we call it
 */
     public static  WebDriver getDriver(){
         ...
         /*same driver instance will be returned every time
         we call Driver.getDriver();  method
          */
         return driver;
     }
